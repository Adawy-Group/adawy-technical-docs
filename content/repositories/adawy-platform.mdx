...
├── studio/     Adawy Studio                → holding page, no domain yet (en/ar)
├── pack/       Adawy Pack                  → holding page, no domain yet (en/ar)
├── print/      Adawy Print                 → holding page, no domain yet (en/ar)
├── supplies/   Adawy Supplies              → holding page, no domain yet (en/ar)
├── marketing/  Adawy Marketing Solutions   → holding page, no domain yet (en/ar)
