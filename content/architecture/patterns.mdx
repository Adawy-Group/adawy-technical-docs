...
Nine repositories, two worlds, no shared code between them
...
written as a lint rule, a test, or a type — so it **fails the build**. This is
the department's most-applied pattern, and it has its own record:
[ADR-012](/architecture/adrs).
