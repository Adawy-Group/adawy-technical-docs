...
2. **Adawy Studio** (`apps/studio`) — the creative flagship; sets the design
   ...
   brand identity. *A branded holding page is live today; the full build is
   next.*
3. **Adawy Pack** (`apps/pack`) — the industrial flagship; establishes the
   ...
   page live today.* Not to be confused with the client project
...
4. **Adawy Print, Adawy Supplies, Adawy Marketing Solutions, Adawy Business
   ...
   Marketing Solutions and Business Development already have holding pages
   live (`apps/print`, `apps/supplies`, `apps/marketing`, `apps/bizdev`).*
