...
- **[Deployment](/how-we-work/deployment)** — previews, staging, production,
  and what CI actually gates on.
- **[Client Projects](/how-we-work/client-projects)** — how work for clients
  differs from Group work, and the go-live switch.
- **[Working with AI](/how-we-work/working-with-ai)** — the `AGENTS.md`
  convention and the rules for AI-assisted code.
