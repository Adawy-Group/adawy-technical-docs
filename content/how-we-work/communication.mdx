...
description: One intake channel, weekly triage, and a written Thursday update - how work reaches the department and how status flows back without a status meeting.
tags: ['Reference', 'Process']
---
